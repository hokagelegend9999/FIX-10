...
const UserList = () => {
  ...
  const handleCancel = () => {
    setIsModalVisible(false);
    setIsEditModalVisible(false); // Menutup modal edit pengguna
  ...
  const getRegionName = (regionId) => {
    const region = regions.find(region => region.uuid === regionId);
      ...
      <Modal title="Edit Users" visible={isEditModalVisible} onOk={handleOkEdit} onCancel={handleCancel}>
        <Form form={form} onFinish={updateUser}>
          ...
          <Form.Item
            label="Contact Person"
            name="contactPerson"
            rules={[{ required: false, message: 'Please input Contact Person!' }]}
          >
            <Input placeholder="Contact Person" />
          </Form.Item>
          <Form.Item
